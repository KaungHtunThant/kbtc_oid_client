<?php
	session_start();
	$_SESSION['currentPage'] = "Usersample";
?>
<!DOCTYPE html>
<html>
		  	...
		  	<div class="container pt-4">
		  		<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Admin Records</li>
					</ol>
				</nav>
				<!-- Return Message -->
				<div class="container">
		  		...
		  		<div class="row px-5">
		  			<div class="col-md-12 px-5 py-3 card">
		  				<!-- <div class="container"> -->
					  		...
					  		?>
					  	<!-- </div> -->
					  	<h4 class="mt-3">User Records</h4>
					  	<hr>
					  	<div class="row">
					  		<div class="col-7 col-md-4">
					  			<a class="btn btn-primary" data-toggle="modal" data-target="#empCreate">Add New Admin</a>
					  		</div>
                                ...
                                <div class="modal-content ">
                                	<form action="postfunctions.php" class="needs-validation" method="POST">
	                                    ...
	                                    <div class="modal-header">
	                                        <h4 class="modal-title mx-auto">New Admin Form</h4>
	                                    </div>
                                        <!-- Modal body -->
                                        	...
                                        	<div class="row">
												...
												<div class="col-12 mb-3">
													<div class="form-outline">
													  	<input type="text" class="form-control" id="validationCustom01" placeholder="eg.KBTC-123" name="adminID" required />
												...
												<div class="col-12 mb-3">
													<div class="form-outline">
												  		<input type="text" class="form-control" id="validationCustom02" placeholder="Otto Oreo" name="adminName" required />
												  		<label for="validationCustom02" class="form-label">Name</label>
												  		<div class="valid-feedback">Admin Name</div>
												  		<div class="invalid-feedback">Enter a valid Name</div>
													</div>
												</div>
												<div class="col-12 mb-3">
													<div class="form-outline">
												  		<input type="text" class="form-control" id="empJoinDate" aria-describedby="inputGroupPrepend" name="adminJoinDate" required />
												...
												<div class="col-12 mb-3">
													<div class="form-outline">
												  		<input type="text" class="form-control" id="officePhone" aria-describedby="inputGroupPrepend" name="officePhone" required />
												  		<label for="officePhone" class="form-label">Office Phone No.</label>
												...
												<div class="col-12 mb-3">
													<div class="form-outline">
												  		<input type="text" class="form-control" id="emergencyPhone" aria-describedby="inputGroupPrepend" name="emergencyPhone" required />
												  		<label for="emergencyPhone" class="form-label">Emergency Phone No.</label>
												  		<div class="valid-feedback">Valid Phone No.</div>
												  		<div class="invalid-feedback">Enter a valid phone no.</div>
													</div>
												</div>
