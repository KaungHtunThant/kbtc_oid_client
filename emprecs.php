						...
						<div class="modal" id="empCreate">
												...
												<div class="col-12 mb-3">
													<div class="form-outline">
														<label for="empPhone" class="form-label">Phone No.</label>
												  		<input type="text" class="form-control" id="empPhone" aria-describedby="inputGroupPrepend" placeholder="Eneter Phone Number" name="empPhone" required />
				  		...
				  		<table class="table table-sm table-striped table-bordered table-light text-center w-100 table-responsive">
				  			...
				  			<tr>
								...
								<!-- Edit Modal -->
								<div class="modal" id="Edit<?php echo $rows->{$tmp}->empID; ?>">
									<div class="modal-dialog">
										<div class="modal-content ">
											<form action="postfunctions.php" class="needs-validation" method="POST">
												<!-- Modal Header -->
												<div class="modal-header">
													<h4 class="modal-title mx-auto">Edit Form</h4>
												</div>
												<!-- Modal body -->
												<div class="modal-body px-5">
													<div class="row">
												...
												<!-- Modal footer -->
												<div class="modal-footer px-5">
													<button class="btn btn-primary" name="empCreate" type="submit">Submit Update</button>
													<button type="button" class="btn btn-outline-info" data-dismiss="modal">Close</button>
												</div>
											</form>
										</div>
